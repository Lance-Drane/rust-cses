...
///
/// The next line has <i>n</i> integers x<sub>1</sub>,x<sub>2</sub>,...,x<sub>n</sub>: the values of the coins.
///
/// <b>Output</b>
///
...
fn main() {
    let mut buf_str = Vec::with_capacity(8192);
...
mod test {
    ...
    fn test(input: &[u8], target: &[u8]) {
        ...
        assert_eq!(String::from_utf8(out), String::from_utf8(target.to_vec()));
    }
